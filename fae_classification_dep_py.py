...
df = pd.DataFrame({
    ...
    "Favorite_Environment": [
        favorite_environment_encoded
    ],

    "Favorite_Season": [
        favorite_season_encoded
    ],

    "Favorite_Time": [
        favorite_time_encoded
    ],
...
if st.button("✨ Discover My Fairy Type ✨"):
    ...
    fairy_descriptions = {
        ...
        "Water Fairy":
        "💧 You are calm, adaptable, and deeply connected to your emotions. Like water, you can flow through any situation with grace.",


        "Forest Fairy":
        "🌲 You are adventurous, grounded, and happiest when surrounded by nature. You have a strong connection with the world around you.",


        "Flower Fairy":
        "🌸 You are creative, gentle, and drawn to beauty. You bring color, warmth, and happiness wherever you go.",


        "Moon Fairy":
        "🌙 You are dreamy, intuitive, and mysterious. You find magic in quiet moments and feel most at home under the night sky.",


        "Starlight Fairy":
        "⭐ You are curious, imaginative, and full of wonder. You are always dreaming about new possibilities and adventures.",


        "Fire Fairy":
        "🔥 You are confident, passionate, and energetic. You have a bright personality and aren't afraid to let yourself shine!"
    }
    ...
    st.markdown(
        ...
        <div class="fairy-result">
            ...
            <div class="fairy-result-title">
                {fairy_emojis[fairy_type]}
                You are a {fairy_type}!
                {fairy_emojis[fairy_type]}
            </div>

            <p class="fairy-result-text">
