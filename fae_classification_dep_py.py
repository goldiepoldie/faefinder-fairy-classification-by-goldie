...
if st.button("✨ Discover My Fairy Type ✨"):
    ...
    # 🧚 Fairy Result Card
    st.markdown(
        f"""<div class="fairy-result"><div class="fairy-result-title">{fairy_emojis[fairy_type]} You are a {fairy_type}! {fairy_emojis[fairy_type]}</div><div class="fairy-result-text">✨ Your magical personality has been revealed ✨</div></div>""",
        unsafe_allow_html=True
    )
